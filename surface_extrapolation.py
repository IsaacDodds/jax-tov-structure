...
# Runs after tov_scan_tracked.py: fit r(P) through the last three valid steps
# with a quadratic, read off the radius at the surface pressure, and take one
# final RK4 step to it.
