...
# Same integration as tov_scan.py, but the carry keeps the last three valid
# steps so the surface can be placed by extrapolation afterwards (see
# surface_extrapolation.py). pressure, f, P_surface, r0, x0 and dr come from
# the project set-up.
