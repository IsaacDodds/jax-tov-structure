...
# The state x = (m, rho, w, dw_dr, v), its right-hand side f, the pressure(rho)
# closure from the spline equation of state, the table P_table, the constants
# G and c, and the starting point (r0, x0, dr) are set up in the project
# notebook and are not part of this repository.
